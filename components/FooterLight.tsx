...
const LINK_COLUMNS = [
  {
    title: "Katalog Data",
    links: [
      { label: "Perjalanan Pilihan Raya", href: "/katalog?bahagian=penjalanan-pilihan-raya" },
...
export default function FooterLight() {
  return (
    <footer className="bg-spr-deep-navy text-white">
      <div className="w-full px-4 sm:px-6 lg:px-10 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/55 text-sm leading-relaxed max-w-sm mb-6">
              Portal data terbuka rasmi Suruhanjaya Pilihan Raya Malaysia.
              Menyediakan akses kepada statistik pemilih, keputusan pilihan raya,
              data persempadanan dan maklumat berkaitan secara terbuka dan telus.
            </p>
